...
console.log( '\nOperation:' );
var operation = justMod2Or3.reduce(function(acumulador, item , index, array){
...
*/
console.log( '\nOperation 2:' );
var operation2 = justMod2Or3.reduceRight(function(acumulador, item , index, array){
    return (acumulador + 1) * item
}, 0)
...
var name = ['vi', 'tor', 'ga', 'ni', 'ko']

var linguaDoP = name.reduce(function(acumulador, item, indice, array){
